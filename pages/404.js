  ...
  return (
    <div>
      ...
      <motion.div initial={{ opacity: 0, y: 180 }} animate={{ opacity: 1, y: 0 }} transition={{ type: "spring", duration: 0.5 }}>
        <div className='text-center custom-margin-body mt-28'>
          <div className="justify-center md:mb-0 mb-20">
            <h1 className="text-5xl font-normal mb-5 text-gray-200 md:text-6xl">404 - Not Found</h1>
            <p className="text-2xl text-gray-400 mb-12">The page you are looking for does not exist.</p>
            <a href="/" className="transition-all text-lg custom-bg px-12 py-2 hover:text-gray-400 hover:pointer rounded-lg block mt-12 lg:inline-block lg:mt-0 text-gray-100 mr-4">Go back</a>
          </div>
